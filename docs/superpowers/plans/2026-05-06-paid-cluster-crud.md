      ...
      "regionConfigs": [
        {
          ...
          "autoScaling": {
            "compute": { "enabled": true, "scaleDownEnabled": true, "minInstanceSize": "M30", "maxInstanceSize": "M60" },
            "diskGB": { "enabled": true }
          }
        }
      ]
  ...
  "replicationSpecs": [
    {
      ...
      "regionConfigs": [
        { "providerName": "AWS", "regionName": "US_EAST_1", "priority": 7,
          "electableSpecs": { "instanceSize": "M30", "nodeCount": 3 },
          "autoScaling": { "compute": { "enabled": true, "maxInstanceSize": "M60" }, "diskGB": { "enabled": true } } },
...
Pass criterion: tool-call log shows `atlas-get-cluster` called *before* `atlas-update-cluster`; update succeeds with no 4xx; `terminationProtectionEnabled` is `true` afterwards.
